...
TEST_PASSWORD1 = getattr(settings, 'ROBOKASSA_TEST_PASSWORD1', None)
TEST_PASSWORD2 = getattr(settings, 'ROBOKASSA_TEST_PASSWORD2', None)
...
FORM_TARGET = u'https://auth.robokassa.ru/Merchant/PaymentForm/FormMS.js'

if TEST_MODE:
    FORM_TARGET = getattr(
        settings, 
        'ROBOKASSA_TEST_FORM_TARGET', 
        u'https://auth.robokassa.ru/Merchant/PaymentForm/FormMS.js'
    )
